...
describe("Cart tests: Price on the cart page and next to the cart icon", () => {
    ...
    it("TC10:Add an item to the cart and validate that total price on the cart page includes shipping rate",{tags: 'total price'}, () => {
        landing.goToTheCartPage();
    ...
    it("TC11: Change the quantity of products in the car and validate that it results in a new total price",{tags: 'total price'}, () => {
        landing.goToTheCartPage();
